...
const getCognitoSignInUri = () => {
    const signinUri = `${appConfig.userPoolBaseUri}/login?response_type=token&client_id=${appConfig.clientId}&scope=email+https://blogsite.auth.us-east-1.amazoncognito.com/blog.all+openid+profile&redirect_uri=${appConfig.callbackUri}`
    return signinUri
}
